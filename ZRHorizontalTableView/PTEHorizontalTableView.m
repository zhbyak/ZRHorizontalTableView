...
+ (instancetype)horizontalTableViewWithFrame:(CGRect)frame andCellReuseIdentifier:(NSString *)reuseID{
    //创建
    PTEHorizontalTableView *hTableView = [[PTEHorizontalTableView alloc] initWithFrame:frame];
    
    [hTableView.tableView registerClass:[UITableViewCell class] forCellReuseIdentifier:reuseID];
    
    return hTableView;

}
//初始化自己并且初始化自己内部的tableView
